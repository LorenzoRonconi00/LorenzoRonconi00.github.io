    ...
    <div className="bg-primary/60 h-full">
      ...
      to-black/10">
        ...
        h-full container mx-auto">
          ...
          exit="hidden"
          className="h1">
            Passione per <br /> lo <span className="text-accent">sviluppo</span>
          </motion.h1>
          <motion.p 
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        <div className="bg-none xl:bg-cover xl:bg-right
        ...
        className="hidden lg:hidden w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-32
